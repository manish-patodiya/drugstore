...
public function manufacturerinfo($manufacturer_id){
...
//            return $query->result();
    ...
    public function Spayment()
    {
     ...
     public function supplierpvoucher()
    {
      return  $data = $this->db->select("VNo as voucher")
            ->from('acc_transaction') 
            ->like('VNo', 'PS-', 'after')
...
//             $IsPosted=1;
//             $IsAppove=1;
//             $sup_id = $this->input->post('manufacturer_id');
...
//       'VDate'          =>  $createdate,
//       'COAID'          =>  $bankcoaid,
//       'Narration'      =>  'Payment amount for '.$supinfo->manufacturer_name,
//       'Debit'          =>  0,
//       'Credit'         =>  $Damnt,
//       'IsPosted'       =>  1,
//       'CreateBy'       =>  $CreateBy,
...
//            // print_r($debitinsert);exit;
//               $this->db->insert('acc_transaction',$manufacturerdebit);
...
//                 $message = 'Mr.'.$supinfo->manufacturer_name.',
...
// }
     ...
     $cc = array(
      ...
      'VDate'          =>  $VDate,
      'COAID'          =>  1020101,
      'Narration'      =>  'Paid to '.$supinfo->manufacturer_name,
      'Debit'          =>  0,
      'Credit'         =>  $Damnt,
      'IsPosted'       =>  1,
      'CreateBy'       =>  $CreateBy,
  ...
  $datapay = array(
      ...
      'deposit_no'     => $voucher_no,
      'amount'         => $Damnt,
      'description'    => 'Paid to '.$supinfo->manufacturer_name,
      'payment_type'   => 1,
      'cheque_no'      => '',
      'date'           => $VDate,
      'status'         => 1,
 ...
 $this->session->set_flashdata('message', display('save_successfully'));
          redirect('accounts/manufacturer_paymentreceipt/'.$manufacturer_id.'/'.$voucher_no.'/'.$dbtid);
  ...
  $datapay = array(
      ...
      'deposit_no'     => $voucher_no,
      'amount'         => $Damnt,
      'description'    => 'Paid to '.$supinfo->supplier_name,
      'payment_type'   => 1,
      'cheque_no'      => '',
      'date'           => $VDate,
      'status'         => 1,
