            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <label class="select"><?php echo display('search_by_date') ?>:
                        ...
                        <input type="text" name="to_date" value="<?php echo $today; ?>"
                            class="datepicker form-control" />
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo 'Patient or Manufacturer' ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="<?php echo base_url() . 'Caccounts/inout_edit/{transection_id}/{table}/edit'; ?>"
                                                    class="btn btn-info btn-sm" data-toggle="tooltip"
                                                    data-placement="left" title=""
                                                    data-original-title="<?php echo display('update') ?> "><i
                                                        class="fa fa-pencil" aria-hidden="true"></i></a>

                                                <a href="<?php echo base_url() . 'Caccounts/inout_edit/{transection_id}/{table}/del'; ?>"
                                                    class="deletePurchase btn btn-danger btn-sm" name="20170114125203"
