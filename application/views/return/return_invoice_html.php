...
if ($this->permission1->method('manage_invoice', 'read')->access()) {?>
    ...
    $com = implode("&nbsp&nbsp", explode(" ", $com));?>
                            ...
                            <div class="table-responsive m-b-20">
                                <table class="table table-bordered" id='table-dtl'>
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo display('discount_percentage') ?>%
                                            </td>
                                            ...
                                            <td class="text-center"><?php echo display('rate') ?></td>
                                    ...
                                    <tfoot style='border: 1px solid; border-color:inherit'>
...
if ($invoice_all_data[0]['total_deduct'] != 0) {
    ...
    if ($invoice_all_data[0]['total_tax'] != 0) {
        ?>
                                        <!-- <tr>
                                            <td style="border-top: 0; border-bottom: 0;"><?php echo display('tax') ?>
                                                :
                                            </td>
                                            <td style="border-top: 0; border-bottom: 0;">
