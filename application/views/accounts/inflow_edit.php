        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    {edit}
                    <form class="form-vertical" action="<?=base_url()?>caccounts/inflow_edit_receiver/{transection_id}/"
                        id="insert_deposit" method="post" name="insert_deposit" enctype="multypart/formdata">
                        <div class="panel-body">
                            ...
                            <div class="form-group row" id="payment_from_1">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input value="{customer_id}" id="SchoolHiddenId" class="customer_hidden_value"
                                        type="hidden" name="customer_id">
                                </div>
                                <div class="col-sm-3">
                                    <input onClick="active_customer('payment_from_1')" type="button"
                                        id="myRadioButton_1" class="btn btn-success checkbox_account"
                                        name="customer_confirm" checked="checked"
                            ...
                            <div class="form-group row" id="payment_from_2">
                                ...
                                <div class="col-sm-3">
                                    <input onClick="active_customer('payment_from_2')" type="button"
                                        ...
                                        name="customer_confirm_others" value="<?php echo "Patient" ?>">
                                </div>
                            </div>
                            ...
                            <div id="bank_info_hide">
                                <div class="form-group row">
                                    <label for="cheque_or_pay_order_no"
                                        class="col-sm-3 col-form-label"><?php echo display('cheque_or_pay_order_no') ?>
                                        <i class="text-danger">*</i></label>
                                    <div class="col-sm-6">
                                        <input type="text" id="amount" class="form-control" value="{cheque_no}"
                                            name="cheque_no"
                                ...
                                <div class="form-group row">
                                    <label for="date" class="col-sm-3 col-form-label"><?php echo display('date') ?> <i
                                            class="text-danger">*</i></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="cheque_mature_date" data-date-format="Y-mm-dd"
                            ...
                            <div class="form-group row">
                                <label for="amount" class="col-sm-3 col-form-label"><?php echo display('ammount') ?> <i
                                        class="text-danger">*</i></label>
                                <div class="col-sm-6">
                                    <input type="number" value="{amount}" id="amount" class="form-control" name="amount"
                                        required />
                                </div>
                            </div>
