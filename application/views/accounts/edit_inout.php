                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="amount"
                                class="col-sm-3 col-form-label"><?php echo display('payment_date') ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="transection_date" data-date-format="yyyy-mm-dd"
                                    value="<?php echo $today; ?>" id="amount" class="datepicker form-control" />
                            </div>
                        </div>

                        <div class="form-group row" id="payment_from_1">
                            <label for="amount"
                                class="col-sm-3 col-form-label"><?php echo display('payment_from') ?></label>
                            <div class="col-sm-6">
                                <input type="text" name="customer_name" class="form-control customerSelection"
                            ...
                            <div class="checkbox checkbox-primary col-sm-3 m-t-5">
                                <input onClick="active_customer('payment_from_1')" type="checkbox" id="myRadioButton_1"
                                    class="checkbox_account" name="customer_confirm" checked="checked">
                                <label for="myRadioButton_1"> <?php echo "Customer" ?> </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="payment_from_2">
                            ...
                            <div class="checkbox checkbox-primary col-sm-3 m-t-5">
                                <input onClick="active_customer('payment_from_2')" type="checkbox" id="myRadioButton_2"
                                    class="checkbox_account" name="customer_confirm_others">
                                <label for="myRadioButton_2"> <?php echo "Patient" ?> </label>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="amount"
                                class="col-sm-3 col-form-label"><?php echo display('payment_type') ?></label>
                            <div class="col-sm-6">
                        ...
                        <div id="bank_info_hide">
                            <div class="form-group row">
                                <label for="amount"
                                    class="col-sm-3 col-form-label"><?php echo display('cheque_or_pay_order_no') ?></label>
                                <div class="col-sm-6">
                                    <input type="test" id="amount" class="form-control" name="cheque_no"
                                        placeholder="<?php echo display('cheque_or_pay_order_no') ?>" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="amount"
                                    class="col-sm-3 col-form-label"><?php echo display('date') ?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="cheque_mature_date" data-date-format="yyyy-mm-dd"
                                        value="<?php echo $today; ?>" id="amount" class="datepicker form-control" />
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="account_table"
                                class="col-sm-3 col-form-label"><?php echo display('payment_account') ?></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" id="amount" name="amount" required
                                    placeholder="<?php echo display('ammount') ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="description" id="description" rows="3"
                                    placeholder="<?php echo display('description') ?>" required=""></textarea>
                            </div>
                        </div>
