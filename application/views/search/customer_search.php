...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo 'Patient Search' ?></h1>
            <small><?php echo 'Patient Search' ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('search') ?></a></li>
                <li class="active"><?php echo 'Patient Search' ?></li>
            </ol>
        </div>
    </section>
                                ...
                                <table class="table table-bordered table-striped table-hover medicine_search">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo 'Patient Address' ?></th>
                                            <th class="text-center"><?php echo 'Patient Mobile' ?></th>
                                            <th class="text-center"><?php echo 'Patient Email' ?></th>
                                            <?php
if ($this->permission1->method('manage_customer', 'read')->access()) {?>
