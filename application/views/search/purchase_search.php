...
if ($this->permission1->method('manage_medicine', 'read')->access()) {?>
                    <a href="<?php echo base_url('Csearch/medicine') ?>" class="btn btn-success m-b-5 m-r-2"><i
                            class="ti-align-justify"> </i> <?php echo display('medicine_search') ?></a>
                    <?php }?>
                    <?php
if ($this->permission1->method('manage_customer', 'read')->access()) {?>
                    <a href="<?php echo base_url('Csearch/customer_search') ?>" class="btn btn-info m-b-5 m-r-2"><i
                            class="ti-align-justify"> </i> <?php echo 'Patient Search' ?></a>
                    <?php }?>
                    <?php
if ($this->permission1->method('manage_invoice', 'read')->access()) {?>
                    <a href="<?php echo base_url('Csearch/invoice') ?>" class="btn btn-primary m-b-5 m-r-2"><i
        ...
        ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><a
                                                    ...
                                                    target="_blank">{chalan_no}</a></td>
                                            <td align="center"><a
                                                    href="<?php echo base_url('Cmanufacturer/manufacturer_details/{manufacturer_id}') ?>"
                                                    target="
                                            ...
                                            <td align="center">
                                                <a href="<?php echo base_url('Cpurchase/purchase_details_data/{purchase_id}'); ?>"
                                                    target="_blank"><button
                                                        class="btn btn-success"><?php echo display('details') ?></button>
                                                </a>
                                            </td>
                                            <?php
}
