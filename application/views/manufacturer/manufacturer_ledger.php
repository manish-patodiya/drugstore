...
if ($this->permission1->method('manufacturer_ledger', 'read')->access()) {?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="manufacturer_name"
                                class="col-sm-3 col-form-label"><?php echo display('select_manufacturer') ?> <i
    ...
    foreach ($manufacturer as $manufacturers) {
        ?>
                                    ...
                                    <option value="<?php echo $manufacturers['manufacturer_id']; ?>"
                                        <?php if ($manufacturers['manufacturer_id'] == $manufacturer_id) {echo 'selected';}?>>
