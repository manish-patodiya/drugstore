...
if ($this->permission1->method('manage_manufacturer', 'create')->access()) {?>
                                    <a href="<?php echo base_url('Cmanufacturer') ?>"
                                        class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i>
                                        <?php echo display('add_manufacturer') ?> </a>
                                    <?php }?>
...
if ($manufacturers_list) {
    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="<?php echo base_url() . 'Cmanufacturer/manufacturer_ledger_info/{manufacturer_id}'; ?>">
                                                {manufacturer_name}
                                            </a>
                                        </td>
                                        <td>{address}</td>
...
if ($this->permission1->method('manage_manufacturer', 'update')->access()) {?>
                                                <a href="<?php echo base_url() . 'Cmanufacturer/manufacturer_update_form/{manufacturer_id}'; ?>"
...
if ($this->permission1->method('manage_manufacturer', 'delete')->access()) {?>
                                                <a href="" class="deletemanufacturer btn btn-danger btn-sm"
                                                    name="{manufacturer_id}" data-toggle="tooltip"
