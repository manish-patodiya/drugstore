                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="txtVNo" id="txtVNo" value="<?php echo $debit_info->VNo; ?>"
                                    class="form-control" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="ac"
                                class="col-sm-2 col-form-label"><?php echo display('debit_account_head') ?></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker"
                                    value="<?php echo $debit_info->VDate; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks"
                                    class="form-control"><?php echo $debit_info->Narration; ?></textarea>
                            </div>
                        </div>
...
foreach ($crvoucher_info as $upcrvoucher) {?>
    ...
    echo 'selected';
                                        ...
                                        <td><input type="text" name="txtCode[]"
                                                value="<?php echo $upcrvoucher->COAID ?>" class="form-control "
                                                id="txtCode_<?php echo $sl; ?>"></td>
                                        <td><input type="text" name="txtAmount[]"
                                                value="<?php echo $upcrvoucher->Credit ?>"
                                                class="form-control total_price" id="txtAmount_<?php echo $sl; ?>"
                                                onkeyup="calculation(<?php echo $sl; ?>)">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="button" id="add_more" class="btn btn-info" name="add_more"
                                                onClick="addaccount('debitvoucher');"
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right "
                                                name="grand_total" value="<?php echo $debit_info->Debit; ?>"
                                                readonly="readonly" />
                                        </td>
                                    </tr>
                                </tfoot>
...
function addaccount(divName) {
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        newdiv.innerHTML = "<td> <select name='cmbCode[]' id='cmbCode_" + count +
            "' class='form-control' onchange='load_code(this.value," + count +
            ")'><?php foreach ($acc as $acc2) {?><option value='<?php echo $acc2->HeadCode; ?>'><?php echo $acc2->HeadName; ?></option><?php }?></select></td><td><input type='text' name='txtCode[]' class='form-control'  id='txtCode_" +
            count +
            "' ></td><td><input type='text' name='txtAmount[]' class='form-control total_price' id='txtAmount_" +
            count + "' onkeyup='calculation(" + count +
            ")'></td><td><button style='text-align: right;' class='btn btn-danger red' type='button' value='<?php echo display("delete") ?>' onclick='deleteRow(this)'><i class='fa fa-trash-o'></i></button></td>";
