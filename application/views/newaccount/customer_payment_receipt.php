                ...
                <div class="panel panel-bd">
                                ...
                                <table border="0" width="100%">
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td class="text-left"><?php echo display('amount'); ?> :
                                                        <?=$payment_info[0]['Credit'];?></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left"><?php echo display('remark'); ?> :
                                                        <?=$payment_info[0]['Narration'];?></td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo display('paid_by') ?>:
                                            ...
                                            <div
                                                style="margin-top:10px;float:right;width:30%;text-align:center;border-top:1px solid #e4e5e7;">
                    ...
                    <div class="panel-footer text-left">
                        <a class="btn btn-danger"
                            href="<?php echo base_url('accounts/customer_receive'); ?>"><?php echo display('cancel') ?></a>
