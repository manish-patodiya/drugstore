                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="txtVNo" id="txtVNo" value="<?php echo $credit_info->VNo ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker"
                                    value="<?php echo $credit_info->VDate; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks"
                                    class="form-control"><?php echo $credit_info->Narration; ?></textarea>
                            </div>
                        </div>
...
foreach ($dbvoucher_info as $debitvoucher) {?>
    ...
    echo 'selected';
                                        ...
                                        <td><input type="text" name="txtCode[]"
                                                value="<?php echo $debitvoucher->COAID; ?>" class="form-control "
                                                id="txtCode_<?php echo $sl; ?>"></td>
                                        <td><input type="text" name="txtAmount[]"
                                                value="<?php echo $debitvoucher->Debit; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="form-control text-right "
                                                name="grand_total" value="<?php echo $credit_info->Credit; ?>"
                                                readonly="readonly" />
                                        </td>
                                    </tr>
                                </tfoot>
