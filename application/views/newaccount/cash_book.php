                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-body" id="printArea">
                            <tr align="center">
                                <td id="ReportName" style="font:'Times New Roman', Times, serif; font-size:20px;">
                                    <b><?php echo display('cash_book_voucher') ?></b>
                                </td>
                            </tr>
                            <div>
...
?>
                                ...
                                <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                                    <caption class="text-center">
                                        <font size="+1" style="font-family:'Arial'"> <strong>
                                                <?php echo display('cash_book_report') ?> (<?php echo display('from') ?>
                                                <?php echo !empty($FromDate) ? $FromDate : ''; ?>
                                                <?php echo display('to') ?>
                                                <?php echo (!empty($ToDate) ? $ToDate : ''); ?>)</font><strong>
                                    </caption>
                                    <tr class="table_data">
                                        <td width="3%">&nbsp;</td>
                                        <td width="10%">&nbsp;</td>
                                    ...
                                    <tr class="table_head"
                                        style="border-top: solid 1px #000;border-bottom: solid 1px #000;">
                                        <th height="25"><strong><?php echo display('sl') ?></strong></th>
                                        <th class="text-center"><strong><?php echo display('date') ?></strong></th>
                                        <th class="text-center"><strong><?php echo display('voucher_no') ?></strong>
                                        </th>
                                        <th class="text-center"><strong><?php echo display('voucher_type') ?></strong>
                                        </th>
                                        <th class="text-center"><strong><?php echo display('particulars') ?></strong>
                                        </th>
...
$VNo = "";
$CountingNo = 1;
for ($i = 0; $i < ($oResult ? $oResult->num_rows : 0); $i++) {
    if ($i & 1) {
        $bg = "#F8F8F8";
    } else {
        $bg = "#FFFFFF";
