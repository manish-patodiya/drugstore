<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo 'Patient Receive' ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active"><?php echo 'Patient Receive' ?></li>
            </ol>
        </div>
    </section>
...
function addaccount(divName) {
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        newdiv.innerHTML = "<td> <select name='supplier_id[]' id='supplier_id_" + count +
            "' class='form-control' onchange='load_code(this.value," + count +
            ")' required><option value=''>Select Customer</option><?php foreach ($customer_list as $customer) {?><option value='<?php echo $customer->customer_id; ?>'><?php echo $customer->customer_name; ?></option><?php }?></select></td><td><input type='text' name='txtCode[]' class='form-control'  id='txtCode_" +
            count +
