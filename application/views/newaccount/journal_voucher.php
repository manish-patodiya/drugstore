...
?>
    ...
    echo $voucher_n = 'Journal-1';
                        ...
                        <div class="form-group row">
                            <label for="date"
                                class="col-sm-2 col-form-label"><?php echo display('transaction_date') ?></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            <label for="txtRemarks"
                                class="col-sm-2 col-form-label"><?php echo display('transaction_details') ?></label>
                            <div class="col-sm-4">
                            ...
                            <table class="table table-bordered table-hover" id="debtAccVoucher">
                                ...
                                <tbody id="debitvoucher">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="txtCode[]" class="form-control " id="txtCode_1">
                                        </td>
                                        <td><input type="number" name="txtAmount[]" value="0"
                                                class="form-control total_price text-right" id="txtAmount_1"
                                                onkeyup="calculation(1)">
                                        </td>
                                        <td><input type="number" name="txtAmountcr[]" value="0"
...
function addaccount(divName) {
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        newdiv.innerHTML = "<td> <select name='cmbCode[]' id='cmbCode_" + count +
            ...
            count + "' value='0' onkeyup='calculation(" + count +
