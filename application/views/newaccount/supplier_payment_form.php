                                        ...
                                        <td class="" style="width: 200px;">
                                            <select name="supplier_id" id="supplier_id_1" class="form-control"
                                                ...
                                                <<option value="">Select Supplier</option>}
                                                    ...
                                                    <option value="<?php echo $suplier->supplier_id; ?>">
                                                        <?php echo $suplier->supplier_name; ?></option>
                                                    <?php }?>
                                            </select>
...
function addaccount(divName) {
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        newdiv.innerHTML = "<td> <select name='supplier_id[]' id='supplier_id_" + count +
            ...
            ")' required><option value=''>Select Supplier</option><?php foreach ($supplier_list as $suplier) {?><option value='<?php echo $suplier->supplier_id; ?>'><?php echo $suplier->supplier_name; ?></option><?php }?></select></td><td><input type='text' name='txtCode[]' class='form-control'  id='txtCode_" +
            count +
