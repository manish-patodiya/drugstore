                        ...
                        <div class="panel-body" id="printArea">
                            <tr align="center">
                                <td id="ReportName" style="font:'Times New Roman', Times, serif; font-size:20px;">
                                    <b><?php echo display('bank_book_voucher') ?></b>
                                </td>
                            </tr>
                            <div class="">
                                ...
                                <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                                    <caption class="text-center">
                                        <font size="+1" style="font-family:'Arial'">
                                            <strong><?php echo display('inventory_ledger_report') ?>(<?php echo display('from') ?>
                                    ...
                                    <tr class="table_head">
                                        ...
                                        <th width="11%" align="right"><strong><?php echo display('debit') ?></strong>
                                        </th>
                                        <th width="11%" align="right"><strong><?php echo display('credit') ?></strong>
                                        </th>
