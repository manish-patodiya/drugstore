...
function quantity_calculate(item) {
    ...
    if (quantity > 0 || discount > 0) {
        if (dis_type == 1) {
            ...
            var temp = price - dis;
            $("#total_price_" + item).val(price.toFixed(2));

            //Tax cal per product
            var tax = temp - ((temp * 100) / (100 + total_tax * 100));
        ...
        $("#total_price_" + item).val(n.toFixed(2)),
            $("#all_tax_" + item).val(c)
    }
    calculateSum();
    invoice_paidamount();
